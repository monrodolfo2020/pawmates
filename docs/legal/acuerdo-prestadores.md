# Acuerdo de Prestadores de Servicios — PawMates

> **BORRADOR — REQUIERE REVISIÓN DE UN ABOGADO MEXICANO ANTES DE USARSE.**
> Este documento no ha sido revisado por un profesional del derecho. Está
> redactado para el modelo de negocio real de PawMates y fundado en
> legislación mexicana vigente, pero un contrato de adhesión que se
> presenta a cientos de negocios no debe publicarse sin dictamen legal.
...
en lo sucesivo se le denominará **"el Prestador"**.

**1.3.** Ambas partes manifiestan tener la capacidad legal para
contratar y obligarse en términos de los artículos 1798 y 1800 del
Código Civil Federal, y que en la celebración de este Acuerdo no media
error, dolo, violencia, lesión ni mala fe.
...
- **Cliente:** el Usuario que contrata directamente los servicios del
  Prestador.
- **Categoría:** la clasificación del Prestador dentro del Directorio.
  A la fecha de este Acuerdo, las categorías son: paseadores,
  veterinarias, estética canina, hotel y guardería, entrenamiento,
  tiendas y otros servicios para mascotas.
- **Plan Gratuito** y **Plan VIP:** los niveles de servicio descritos en
  la cláusula 12.
- **Contenido del Prestador:** los textos, fotografías, logotipos,
  precios, horarios, testimonios y cualquier otro material que el
  Prestador cargue o publique en la Plataforma.
...
b) genera y aloja un Micrositio con una dirección única y compartible;
c) pone a disposición del Prestador herramientas para editar la
   información y las imágenes de su Micrositio; y
d) en el caso de la categoría de paseadores, y únicamente en esa
...
b) **no es parte** del contrato que el Prestador celebre con sus
   Clientes, ni interviene en su negociación, contenido o cumplimiento;
c) **no garantiza** al Prestador un volumen mínimo de Clientes,
   contactos, visitas, reservas o ingresos de ninguna clase;
d) **no actúa como agente, comisionista, mandatario, representante ni
   intermediario** del Prestador frente a sus Clientes;
e) **no cobra, retiene, administra ni procesa** el precio de los
   servicios que el Prestador presta a sus Clientes, el cual se pacta y
   se paga directamente entre ellos, por los medios que ellos acuerden;
f) **no supervisa, dirige ni controla** la forma, el tiempo, el lugar ni
   el modo en que el Prestador presta sus servicios; y
g) **no verifica la calidad, la idoneidad profesional ni la seguridad**
...
## 4. Ausencia de relación laboral, societaria o de subordinación
...
relación de trabajo requiere la prestación de un trabajo personal
subordinado mediante el pago de un salario. En la relación que este
...
**4.3.** El Prestador es el único patrón de las personas que, en su caso,
...
**4.4.** Este Acuerdo tampoco constituye sociedad, asociación en
participación, coinversión, franquicia, agencia, comisión mercantil ni
subcontratación de personal en términos de la Ley Federal del Trabajo.

**4.5.** Ninguna de las partes podrá obligar a la otra frente a
terceros, ni ostentarse como su representante.

---

## 5. Requisitos de elegibilidad e inscripción

**5.1.** Para registrarse como Prestador se requiere:

a) ser persona física mayor de 18 años con capacidad legal, o persona
   moral legalmente constituida en México y debidamente representada;
b) proporcionar una cuenta de correo electrónico válida y verificarla;
c) proporcionar información veraz, completa, actual y verificable sobre
...
engañosa, desactualizada o atribuida indebidamente es causa de
suspensión o terminación conforme a la cláusula 16.
...
## 6. Obligaciones del Prestador en la prestación de sus servicios

**6.1. Cumplimiento normativo.** El Prestador se obliga a prestar sus
servicios cumpliendo toda la legislación aplicable, de manera enunciativa
y no limitativa:

a) las leyes de protección y bienestar animal federales y de la entidad
   federativa en que opere;
b) la Ley Federal de Sanidad Animal y las disposiciones que de ella
   emanen, cuando su actividad esté sujeta a ellas;
c) cuando ofrezca servicios médico-veterinarios, contar con título
   profesional y cédula profesional vigentes de médico veterinario
   zootecnista, o con el personal que los tenga, y con los avisos,
   licencias y registros sanitarios que correspondan al establecimiento;
d) cuando ofrezca hospedaje, guardería, transporte, estética o
   entrenamiento, cumplir las normas de seguridad, higiene, uso de suelo,
   protección civil y trato digno al animal aplicables; y
e) cuando venda productos, cumplir la normatividad de etiquetado,
   información comercial e inocuidad que corresponda.

**6.2. Trato a los animales.** El Prestador se obliga a tratar a todo
animal bajo su cuidado con diligencia, sin maltrato, y a dar aviso
inmediato al Cliente ante cualquier incidente, enfermedad, lesión,
...
## 7. Contenido del Prestador y su Micrositio

**7.1. Responsabilidad sobre el Contenido.** El Prestador es el único
autor y responsable del Contenido del Prestador. Declara que cuenta con
...
Prestador, con el único fin de operar, mostrar y promover el Directorio y
el Micrositio del propio Prestador, así como de promocionar la Plataforma
en sus propios canales. Esta licencia no transfiere la titularidad de
ningún derecho de autor y termina, para usos futuros, al terminar este
Acuerdo, sin perjuicio de las copias de respaldo y de los materiales
promocionales ya difundidos.

**7.3. Contenido prohibido.** El Prestador se obliga a no publicar:

a) información falsa o engañosa sobre sus servicios, precios,
   certificaciones, experiencia, instalaciones o resultados;
b) fotografías, textos, marcas o logotipos de terceros sobre los que no
   tenga derechos, ni imágenes que no correspondan a su propio negocio;
c) afirmaciones sobre servicios médico-veterinarios, medicamentos o
   resultados terapéuticos que no pueda sustentar o que requieran
   autorización sanitaria que no posea;
d) datos personales de sus Clientes o de terceros sin su consentimiento;
e) contenido discriminatorio, violento, sexual, ilícito o que promueva el
   maltrato animal; ni
f) precios o promociones que no esté dispuesto a respetar, en términos de
...
## 8. Reservas, contacto y pago de los servicios

**8.1. Categorías con reserva en la Plataforma.** En la categoría de
paseadores, la Plataforma permite a los Usuarios enviar solicitudes de
reserva y sostener mensajería con el Prestador. El Prestador es libre de
aceptar o rechazar cada solicitud. La aceptación perfecciona un contrato
**exclusivamente entre el Prestador y el Cliente**.

**8.2. Demás categorías.** En las categorías restantes, la Plataforma
únicamente muestra los datos de contacto que el propio Prestador publica
y facilita al Usuario comunicarse con él por medios externos. Toda
contratación ocurre fuera de la Plataforma.
...
**8.4. Comprobantes fiscales al Cliente.** El Prestador es el único
...
b) verificación de títulos, cédulas profesionales, certificaciones,
   licencias, permisos o registros sanitarios;
c) validación de la autenticidad del documento ante autoridad alguna;
d) inspección de instalaciones, vehículos o equipos;
e) evaluación de aptitudes, experiencia o competencia profesional; ni
...
**10.2. El Prestador como responsable.** Respecto de los datos personales
de sus Clientes y de terceros que obtenga con motivo de su actividad
—incluidos los que reciba a través de la Plataforma—, **el Prestador
actúa como responsable independiente** y asume por su cuenta el
cumplimiento de la legislación en materia de datos personales, incluida
la obligación de contar con su propio aviso de privacidad y de atender
los derechos de los titulares.

**10.3.** El Prestador se obliga a utilizar los datos de contacto de los
Usuarios que obtenga por conducto de la Plataforma **únicamente para
atender la solicitud de servicio correspondiente**, y a no emplearlos
para publicidad no solicitada, cesión a terceros o finalidades ajenas.

**10.4.** Cada parte notificará a la otra, sin demora injustificada,
cualquier vulneración de seguridad de datos personales de la que tenga
conocimiento y que afecte a la otra parte o a los Usuarios.
...
**12.2. Plan VIP.** De pago. Comprende todo lo del Plan Gratuito y,
adicionalmente, las herramientas de personalización del Micrositio:
selección de plantilla, colores y tipografía, carga de logotipo y
portada, activación, desactivación y reordenamiento de secciones, y
publicación de testimonios, con las características y límites que la
Plataforma tenga habilitados en cada momento.

**12.3. Efecto del vencimiento o la baja del Plan VIP.** Si el Plan VIP
...
c) el diseño personalizado que el Prestador hubiera creado **se
   conserva** y no se elimina, de modo que si el Prestador reactiva el
   Plan VIP su Micrositio vuelve a exhibirse tal como lo dejó; y
...
de un mes o de doce meses. **Concluido el periodo contratado, el plan
vence** y el Micrositio vuelve al diseño estándar conforme a la cláusula
12.3, salvo que el Prestador lo renueve.

**13.3. Renovación anticipada.** Si el Prestador renueva antes del
vencimiento, el nuevo periodo **se suma al tiempo que le resta**, sin
pérdida de los días no consumidos. Si renueva después del vencimiento, el
...
el Prestador no está de acuerdo, podrá no renovar.
...
**13.9.** El Prestador podrá dejar de usar el Plan VIP en cualquier
momento; el plan seguirá vigente hasta el término del periodo pagado.
...
**14.2.** El Prestador declara encontrarse inscrito en el Registro
...
## 15. Declaraciones y obligaciones adicionales del Prestador

El Prestador declara y se obliga a:

**15.1.** Usar la Plataforma de buena fe y no realizar conductas
dirigidas a manipular su posicionamiento, sus búsquedas o sus métricas.

**15.2.** No utilizar la Plataforma para ofrecer servicios distintos de
...
**16.1. Terminación por el Prestador.** El Prestador podrá terminar este
Acuerdo en cualquier momento solicitando la baja de su cuenta, sin
...
a) el Prestador proporcione información falsa sobre su identidad, su
   negocio o sus credenciales;
b) publique testimonios fabricados o publicidad engañosa;
c) exista indicio razonable de maltrato animal, de un hecho que pueda
   constituir delito o de riesgo para la integridad de personas o
   animales;
d) carezca de las licencias, permisos o títulos profesionales exigibles
   para su actividad;
...
a) el Micrositio deja de ser público y su dirección deja de funcionar;
b) el Prestador deja de aparecer en el Directorio;
...
contraídas frente a sus Clientes, que deberá cumplir o resolver
...
a) los servicios que el Prestador presta, ni por su calidad, seguridad,
   legalidad, oportunidad o resultado;
b) los daños, lesiones, enfermedades, extravíos o muerte de animales
   ocurridos con motivo de los servicios del Prestador;
c) los actos u omisiones de los Clientes o de otros Prestadores;
d) el incumplimiento de pago de los Clientes;
e) el Contenido del Prestador; ni
...
incumplimiento de la legislación aplicable a su actividad, el tratamiento
que dé a datos personales, o el incumplimiento de este Acuerdo.

---

## 18. Confidencialidad

Cada parte se obliga a no divulgar la información que reciba de la otra
con carácter confidencial y que no sea pública, y a usarla únicamente
para los fines de este Acuerdo. Esta obligación subsiste dos años
después de la terminación. No se considera confidencial la información
que sea o llegue a ser pública sin culpa de la parte receptora, la que ya
obraba legítimamente en su poder, o aquella cuya divulgación sea exigida
...
**19.2.** Si el Prestador no está de acuerdo con la modificación, podrá
terminar este Acuerdo antes de su entrada en vigor conforme a la cláusula
16.1, con derecho a la devolución proporcional del periodo de suscripción
no transcurrido. El uso de la Plataforma después de la entrada en vigor
se entenderá como aceptación de la versión modificada.

**19.3.** Las modificaciones **no aplicarán retroactivamente** a hechos
...
**20.2.** Las partes reconocen la validez del consentimiento otorgado por
medios electrónicos en términos del artículo 1803 del Código Civil
Federal y de las disposiciones sobre comercio electrónico del Código de
Comercio, y que los mensajes de datos y los registros que la Plataforma
conserve harán prueba de los actos realizados.

---

## 21. Ley aplicable, contrato de adhesión y solución de controversias

**21.1.** Este Acuerdo se rige por la legislación federal mexicana. Le
resultan aplicables, entre otras, el Código Civil Federal, el Código de
Comercio, la Ley Federal de Protección al Consumidor, la Ley Federal de
Protección de Datos Personales en Posesión de los Particulares y la Ley
...
de Protección al Consumidor**, en particular las que impliquen renuncia
de derechos irrenunciables, prestaciones desproporcionadas o inversión de
la carga de la prueba en perjuicio del adherente.

**21.3.** Las partes procurarán resolver de buena fe cualquier
controversia mediante negociación directa, dentro de los treinta días
naturales siguientes a la notificación de la inconformidad.
...
**22.1. Integridad.** Este Acuerdo, junto con el Aviso de Privacidad y
las políticas que expresamente lo complementen, constituye el acuerdo
íntegro entre las partes respecto de su objeto.

**22.2. Nulidad parcial.** Si alguna cláusula fuera declarada nula o
ineficaz, las demás conservarán plena validez, y la cláusula afectada se
interpretará en el sentido más próximo a la intención original que sea
compatible con la ley.

**22.3. No renuncia.** La tolerancia de una parte ante el incumplimiento
...
**22.5. Idioma.** Este Acuerdo se celebra en español, idioma que rige su
interpretación.
...
# Notas para tu abogado (no forman parte del contrato)

Esta sección debe borrarse antes de publicar el Acuerdo.

## Premisas de hecho sobre las que está redactado

El contrato se apoya en cinco hechos verificados en la propia aplicación.
**Si alguno deja de ser cierto, hay que rehacer las cláusulas que se
indican.**

1. **PawMates nunca toca el dinero entre cliente y prestador.** No hay
   cobro, retención ni procesamiento de esos pagos. Es la premisa de las
   cláusulas 3.2(e), 8.3 y 14.3, y es la razón por la que el contrato
   sostiene que no aplica el régimen fiscal de plataformas digitales
...
1. **¿El prestador es "consumidor" para la LFPC?** Es la pregunta más
   importante del documento. Si un micronegocio que paga una suscripción
   se considera consumidor, entran las reglas de contratos de adhesión,
   la nulidad de cláusulas abusivas y la competencia de PROFECO, lo que
   afecta directamente a las cláusulas 13.8 (devoluciones), 17.3 (tope de
   responsabilidad) y 21. El contrato ya está redactado de forma
   conservadora, asumiendo que sí lo es, pero conviene confirmarlo.
2. **¿Este contrato de adhesión requiere registro ante PROFECO?** El
   registro es obligatorio solo para ciertos giros. Si aplicara y no se
   registra, las cláusulas no obligarían al adherente.
3. **Riesgo laboral con los paseadores.** Son la categoría más expuesta a
   que alguien alegue subordinación, porque son los únicos que reciben
   solicitudes dentro de la app. La cláusula 4 está construida sobre el
   artículo 20 de la LFT, pero pídele que revise si algo de la mecánica
   real de la app (mensajería, aceptar/rechazar, seguimiento del paseo)
   puede leerse como control.
4. **Tope de responsabilidad.** Verifica si el límite de la cláusula 17.3
   es sostenible, sobre todo frente a daños a animales, donde puede
   haber responsabilidad extracontractual que no se puede limitar por
   contrato.
5. **Devoluciones.** Define el plazo de la cláusula 13.8 y confirma que
   la política no choque con derechos irrenunciables.
6. **Cláusula 16.4(a).** Al terminar, el enlace del micrositio deja de
   funcionar. Es correcto comercialmente, pero si el negocio lo imprimió
   en volantes o lo puso en su fachada, es donde van a estar los
   reclamos. Quizá convenga un periodo de gracia.

## Lo que todavía falta y no está en este documento

Este Acuerdo cubre solo el lado de los prestadores. Para operar te faltan
tres documentos más, y dos de ellos son obligatorios:

1. **Aviso de Privacidad** — *obligatorio* por la LFPDPPP. La cláusula 10
   lo da por existente. Hoy no existe. Es urgente, sobre todo porque la
   app almacena fotografías de rostros y de documentos de
   identificación, que son datos personales sensibles en su tratamiento.
2. **Términos y Condiciones para dueños de mascotas** — el otro lado del
   mercado. Sin ellos, la plataforma no ha limitado nada frente a quien
   contrata.
3. **Política de contenido y moderación** — opcional, pero le daría
   sustento a la cláusula 7.5.

## Un hueco técnico

La aplicación **no tiene hoy ninguna casilla de aceptación** en el
registro, ni guarda evidencia de que alguien aceptó nada. La cláusula 23
describe un mecanismo que aún no existe. Un contrato que nadie aceptó y
del que no hay registro es muy difícil de hacer valer: conviene
implementar la casilla, guardar fecha, hora y versión aceptada, y
conservar ese registro.
